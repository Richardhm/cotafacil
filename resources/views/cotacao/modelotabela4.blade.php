...
<head>
    ...
    <style>
        ...
        .footer .middle p {margin: 0px;color:rgb(5,53,95);font-weight: bold;line-height:1;padding:0;}
        .footer .right {bottom:20px;right: 30px;text-align: left;display:block;font-size:2em;}
        .footer .right p {margin: 0;color:rgb(5,53,95);font-weight: bold;}
...
<body>
<img src="layouts/modelo4.png" style="position:absolute;top:0;left:0;object-fit: cover;width:100%" />
<p class="cidade_container" style="text-transform:uppercase;width:100%">{{ $cidade_nome }}</p>
