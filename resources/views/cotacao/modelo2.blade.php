...
<head>
    ...
    border: 3px solid rgb(12,77,193);
        ...
        /* === SEM COPAR (COM COPART PARCIAL) - tema azul === */
...
<img style="position: absolute;top: 0;left: 0;height: 100%;width: 100%;object-fit: cover;" src="{{ $folder ? $folder . '/' : '' }}layouts/modelo2.png" alt="Orçamento">
        ...
        <div style="{{($com_coparticipacao == 1 || $sem_coparticipacao == 1) && $carencia == 1 && $quantidade_carencia >= 1 ? 'width: 50%;float:left' : 'width:50%;float:left;margin-left:490px;' }}">
            ...
            <div>
                ...
                <div class="lista-coparticipacao" style="margin: 0 0 0 50px; padding: 0; line-height: 1;color:rgb(12,77,193);">
                    @if($status_excecao == 0)
                        @if(isset($pdf->linha03) && !empty($pdf->linha03))
                            <p style="font-size:1.5em;margin:0;padding:0;font-weight:bold;">** {{$pdf->linha03}}</p>
                        @endif
                    @else
                        @if(isset($pdf->linha03) && !empty($pdf->linha03))
                            <p style="font-size:1.5em;margin:0;padding:0;font-weight:bold;">** {{$pdf->linha03}}</p>
...
@endif
            ...
            @if(isset($pdf->linha01) && !$apenas_valores && $sem_coparticipacao == 1)
                <div style="margin-top:15px;margin-left:50px;">
                    <div style="width:73%;border-radius:35px;overflow:hidden;">
                        ...
                        @if(!empty($linha_02))
                            ...
                            <table style="width:100%;border-collapse:collapse;margin:0;background:rgb(254,199,72);"><tr>
                                    <td style="padding:8px 14px;color:white;font-weight:bold;font-size:1.1em;line-height:1.2;color:rgb(8,73,189);">{{$lbl2}}</td>
