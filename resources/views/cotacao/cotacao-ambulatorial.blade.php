...
{{--    </label>--}}
    ...
    <label for="status_carencia">
        <input type="checkbox" checked="checked" name="status_carencia_ambulatorial" id="status_carencia_ambulatorial" class="w-6 h-6 text-teal-600 bg-white border border-2 border-black rounded dark:bg-white dark:border-purple-900">
    ...
    @if($status_desconto)
        <label for="status_desconto">
            <input type="checkbox" checked="checked" name="status_desconto_ambulatorial" id="status_desconto_ambulatorial" class="w-6 h-6 text-teal-600 bg-white border border-2 border-black rounded dark:bg-white dark:border-purple-900">
