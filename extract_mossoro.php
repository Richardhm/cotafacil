...
$out = [
    'individual_p21' => $individualPages[21] ?? null,
    'ss_p7'          => $ssPages[7] ?? null,
    'amb_p15'        => $ambPages[15] ?? null,
];

file_put_contents(__DIR__ . '/public/mossoro_raw.json', json_encode($out, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE));
echo "Done\n";
