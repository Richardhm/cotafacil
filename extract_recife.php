...
$out = [
    'individual_p23' => $individualPages[23] ?? null,
    'ss_p12'         => $ssPages[12] ?? null,
    'amb_p19'        => $ambPages[19] ?? null,
];

file_put_contents(__DIR__ . '/public/recife_raw.json', json_encode($out, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE));
echo "Done\n";
